        ...
        {navItems.map(item => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center justify-start gap-4 px-4 py-3 rounded-xl text-sm font-medium transition-all ${
                isActive ? 'bg-indigo-600/10 text-indigo-400' : 'hover:bg-slate-800/50 hover:text-white'
              }`}
            >
