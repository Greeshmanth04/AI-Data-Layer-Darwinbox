    ...
    <div className="flex h-screen bg-white font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <main className="flex-1 overflow-hidden bg-white">
          ...
          {activeTab === 'access' && (user?.role === 'platform_admin' ? <AccessControl /> : <div className="flex items-center justify-center h-full text-slate-400 font-medium">Access restricted to Platform Admins only.</div>)}
